...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://www.pixelstalk.net/wp-content/uploads/2015/06/Cute-Anime-Girl-Wallpaper-Kiss-me.jpg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️m.Shamnad✨️━━━━━⛦


𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 m.Shamnad 𝐛𝐨𝐭.
            *Shamzy*
