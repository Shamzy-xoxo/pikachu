...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('Shamzy Running! 😎')
        );
    });
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______ 𝐒𝐇𝐀𝐌𝐙𝐘 _____🕊️♥️~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Da Errors illaathha Bot illada 😁 samadhanikk nammakk settaaka'
                                    , MessageType.text);
                            }
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [♥️🕊️______ 𝐒𝐇𝐀𝐌𝐙𝐘 _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Da Errors illaathha Bot illada 😁 samadhanikk nammakk settaaka' +
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [♥️🕊️______ 𝐒𝐇𝐀𝐌𝐙𝐘 _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                        '*\n\n Da Errors illaathha Bot illada 😁 samadhanikk nammakk settaaka' +
